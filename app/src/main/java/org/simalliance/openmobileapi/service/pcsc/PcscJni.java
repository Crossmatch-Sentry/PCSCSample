...
import org.simalliance.openmobileapi.service.pcsc.PcscException.ErrorCode;
...
public final class PcscJni {
	...
	public static abstract class ReaderState {
		 ...
		 * will be set.
		 */
		public static final int Ignore = 0x00000001;
	...
	static {
		try {
			Runtime.getRuntime().loadLibrary("pcsc_jni");
		} catch (Throwable t) {
			loadException = t;
		}
	}
