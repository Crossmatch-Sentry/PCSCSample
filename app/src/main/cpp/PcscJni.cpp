...
#define LOGI(...) \
  ((void)__android_log_print(ANDROID_LOG_INFO, "PcscJni::", __VA_ARGS__))
...
/*
 * Class:     org_simalliance_openmobileapi_service_pcsc_PcscJni
 * Method:    BeginTransaction
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_org_simalliance_openmobileapi_service_pcsc_PcscJni_BeginTransaction
  (JNIEnv *env, jobject obj, jlong jhCard)
{
  LOGI("BeginTransaction:");

  jlong iRet = SCardBeginTransaction((SCARDHANDLE) jhCard);
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_org_simalliance_openmobileapi_service_pcsc_PcscJni_Cancel
  (JNIEnv *env, jobject obj, jlong jcontext)
{

  jlong iRet = SCardCancel((SCARDCONTEXT) jcontext);
 ...
 */
JNIEXPORT jlong JNICALL Java_org_simalliance_openmobileapi_service_pcsc_PcscJni_Connect
  (JNIEnv *env, jobject obj, jlong jcontext, jstring jreader, jint jshareMode, jintArray jprotocol)
{
  ...
  jlong iRet = SCardConnect((SCARDCONTEXT) jcontext, reader, (DWORD) jshareMode, (DWORD) protocol[0], &hCard, &activeProtocol);
  env->ReleaseStringUTFChars(jreader, reader);
 ...
 * Signature: (JI[B)[B
 */
JNIEXPORT jbyteArray JNICALL Java_org_simalliance_openmobileapi_service_pcsc_PcscJni_Control
  (JNIEnv *env, jobject obj, jlong jhCard, jint jcontrolCode, jbyteArray jcommand)
{
  ...
  jlong iRet = SCardControl((SCARDHANDLE) jhCard, (DWORD) jcontrolCode, command, commandLength, response, sizeof(response), &responseLength);
  if (command != NULL)
 ...
 * Signature: (JI)V
 */
JNIEXPORT void JNICALL Java_org_simalliance_openmobileapi_service_pcsc_PcscJni_Disconnect
  (JNIEnv *env, jobject obj, jlong jhCard, jint jdisposition)
{

  jlong iRet = SCardDisconnect((SCARDHANDLE) jhCard, (DWORD) jdisposition);
 ...
 * Signature: (JI)V
 */
JNIEXPORT void JNICALL Java_org_simalliance_openmobileapi_service_pcsc_PcscJni_EndTransaction
  (JNIEnv *env, jobject obj, jlong jhCard, jint jdisposition)
{

  jlong iRet = SCardEndTransaction((SCARDHANDLE) jhCard, (DWORD) jdisposition);
 ...
 * Signature: (I)J
 */
JNIEXPORT jlong JNICALL Java_org_simalliance_openmobileapi_service_pcsc_PcscJni_EstablishContext
  (JNIEnv *env, jobject obj, jint jscope)
{
  SCARDCONTEXT context;

  jlong iRet = SCardEstablishContext((DWORD) jscope, NULL, NULL, &context);
 ...
 * Signature: (JI)[B
 */
JNIEXPORT jbyteArray JNICALL Java_org_simalliance_openmobileapi_service_pcsc_PcscJni_GetAttrib
  (JNIEnv *env, jobject obj, jlong jhCard, jint jattrId)
{
  jbyte attr[ATTRIB_RSP_BUF_SIZE];
  DWORD attrLength = ATTRIB_RSP_BUF_SIZE;

  jlong iRet = SCardGetAttrib((SCARDHANDLE) jhCard, (DWORD) jattrId, (LPBYTE) attr, &attrLength);
 ...
 */
JNIEXPORT jboolean JNICALL Java_org_simalliance_openmobileapi_service_pcsc_PcscJni_GetStatus
  (JNIEnv *env, jobject obj, jlong jcontext, jlong jtimeout, jobjectArray jreaderNames, jintArray jcurrentStatus, jintArray jeventStatus)
{
  ...
  jlong iRet = SCardGetStatusChange((SCARDCONTEXT) jcontext, (DWORD) jtimeout, readerStates, numberOfReaders);
 ...
 */
JNIEXPORT jbyteArray JNICALL Java_org_simalliance_openmobileapi_service_pcsc_PcscJni_GetStatusChange
  (JNIEnv *env, jobject obj, jlong jcontext, jlong jtimeout, jstring jreaderName, jintArray jstatus)
{
  ...
  jlong iRet = SCardGetStatusChange((SCARDCONTEXT) jcontext, (DWORD) jtimeout, &readerState, 1);
  env->ReleaseStringUTFChars(jreaderName, readerName);
 ...
 */
JNIEXPORT jstring JNICALL Java_org_simalliance_openmobileapi_service_pcsc_PcscJni_ListReaders
  (JNIEnv *env, jobject obj, jlong jcontext, jstring jgroups)
{
  ...
  jlong iRet = SCardListReaders((SCARDCONTEXT) jcontext, groups, NULL, &readerLength);
  if (iRet != SCARD_S_SUCCESS)
  {
    if (jgroups != NULL)
 ...
 * Signature: (JII[I)V
 */
JNIEXPORT void JNICALL Java_org_simalliance_openmobileapi_service_pcsc_PcscJni_Reconnect
  (JNIEnv *env, jobject obj, jlong jhCard, jint jshareMode, jint jinitialization, jintArray jprotocol)
{
  ...
  jlong iRet = SCardReconnect((SCARDHANDLE) jhCard, (DWORD) jshareMode, (DWORD) protocol[0], (DWORD) jinitialization, &activeProtocol);
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_org_simalliance_openmobileapi_service_pcsc_PcscJni_ReleaseContext
  (JNIEnv *env, jobject obj, jlong jcontext)
{
  jlong iRet = SCardReleaseContext((SCARDCONTEXT) jcontext);
 ...
 * Signature: (J[I[I)[B
 */
JNIEXPORT jbyteArray JNICALL Java_org_simalliance_openmobileapi_service_pcsc_PcscJni_Status
  (JNIEnv *env, jobject obj, jlong jhCard, jintArray jstatus, jintArray jprotocol)
{
  ...
  jlong iRet = SCardStatus((SCARDHANDLE) jhCard, reader, &readerLength, &state, &protocol, (LPBYTE) atr, &atrLength);
 ...
 * Signature: (JI[B)[B
 */
JNIEXPORT jbyteArray JNICALL Java_org_simalliance_openmobileapi_service_pcsc_PcscJni_Transmit
  (JNIEnv *env, jobject obj, jlong jhCard, jint jprotocol, jbyteArray jcommand)
{
  ...
  const SCARD_IO_REQUEST *sendPci_t = &sendPci;
  ...
  jlong iRet = SCardTransmit((SCARDHANDLE) jhCard, sendPci_t, (LPCBYTE) command, commandLength, NULL, (LPBYTE) response, &responseLength);
  env->ReleaseByteArrayElements(jcommand, command, 0);
