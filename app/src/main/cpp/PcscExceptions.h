...
#define PCSC_EXCEPTION_CLASS "org/simalliance/openmobileapi/service/pcsc/PcscException"
 ...
 * return: 0 for success, -1 if exception could not be raised
 */
int throwPcscException(JNIEnv *env, jobject obj, const char *functionName, jlong returnCode);
